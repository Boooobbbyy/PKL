    ...
    <div class="center-mode">
        <div class="h-48 px-2">
            <div class="h-full bg-gray-200 dark:bg-dark-1 rounded-md">
                <div class="h-full image-fit rounded-md overflow-hidden"> <img alt="Midone Tailwind HTML Admin Template" src="/assets/dist/images/preview-11.jpg" /> </div>
            </div>
        </div>
        <div class="h-48 px-2">
            <div class="h-full bg-gray-200 dark:bg-dark-1 rounded-md">
                    ...
                    <td class="w-40">
                        <div class="flex">
                            <div class="w-24 h-24 relative image-fit cursor-pointer zoom-in">
                                <img class="rounded-md" alt="slider1" src="/assets/dist/images/preview-11.jpg">
                            </div>
                        </div>
                    </td>
                    <td class="w-1">
