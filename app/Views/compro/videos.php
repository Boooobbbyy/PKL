        ...
        <table class="table table-report -mt-2">
            ...
            <tbody>
                <tr class="intro-x">
                    ...
                    <td class="w-48">
                        <a class="font-medium whitespace-nowrap">JUDUL</a>
                    </td>
                    <td class="w-48">
                        <a class="font-medium whitespace-nowrap">Nikon Z6</a>
                    </td>
                    <td class="w-48">
                        <div class="font-medium whitespace-nowrap">bLABLBALBLA</div>
                    </td>
                ...
                <tr class="intro-x">
                    ...
                    <td class="w-48">
                        <div class="font-medium whitespace-nowrap">Nike Air Max 270</div>
                    </td>
                    <td class="w-48">
                        <div class="font-medium whitespace-nowrap">bLABLBALBLA</div>
                    </td>
